...
description: Generate a structured session report.
model: gpt-5.4-mini
...
The session context summary is an orientation aid. For full detail, inspect the inherited parent conversation context and focus on user messages, assistant text responses, and notable tool outcomes.
...
tags: [obsidian-sync, codex, session, {topic-specific tags}]
type: session-note
